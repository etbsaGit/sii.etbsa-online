<template>
  <div class="component-wrap">
    <!-- form -->
    <v-card>
      <v-card-title> <v-icon>vpn_key</v-icon> Edit Permission </v-card-title>
...
export default {
  ...
  methods: {
    save() {
      ...
      axios
        .put("/admin/permissions/" + self.propPermissionId, payload)
    ...
    loadPermission(cb) {
      ...
      axios
        .get("/admin/permissions/" + self.propPermissionId)
        .then(function (response) {
