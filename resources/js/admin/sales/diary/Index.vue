<template>
  <v-card height="100%">
    <v-navigation-drawer v-model="drawer" width="250" touchless absolute>
      <v-sheet color="grey lighten-4" class="d-flex pa-4 align-center">
        <v-subheader class="text-h5">Filtro</v-subheader>
      </v-sheet>
...
export default {
  ...
  methods: {
    ...
    async loadHistorical(cb) {
      ...
      await axios
        .get("/admin/tracking/historical/diary", { params: payload })
